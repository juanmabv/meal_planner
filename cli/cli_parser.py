...
def parse_cli_arguments() -> Dict[str, Any]:
    ...
    parser.add_argument("--days", type=int, required=True, help="Number of days to cover")
    ...
    parser.add_argument("--optimize", choices=["minimize_shopping", "minimize_prep_time", "use_expiring_food"], default="minimize_shopping", help="Optimization goal")
